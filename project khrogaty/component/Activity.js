      ...
      <Content>
          <List >
            <ListItem thumbnail style={{marginTop:10}}>
              <Left >
                <Thumbnail square source={require('./../img/Icons/home-third-icon.png')}
                  style={{width:35, height:40,borderRadius:5}}/>
              </Left>
              <Body style={{borderBottomWidth: 0}}>
                <Text style={{fontWeight:'bold',fontSize:15,width:250}}>What Do I Do ?</Text>
           ...
           this.state.dataSource.map((item,num) => {
                  return (
                    <Body key={num} style={{flex:4}}>
                      ...
                      <Text style={{fontWeight:'bold',fontSize:10,marginTop:4,marginLeft:5}}>{item.slug} </Text>
